...
require (
	...
	github.com/linguohua/titan v0.0.0-20220915100612-4abeecb0765a // indirect
...
replace github.com/ipfs/go-blockservice v0.4.0 => github.com/timtide/go-blockservice v1.0.0
